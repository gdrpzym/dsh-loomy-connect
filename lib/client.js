...
.dlc_tableHeader{align-items:center;display:grid;color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:500;line-height:1.5;padding:8px;grid-template-columns:minmax(104px,2fr) minmax(52px,auto) minmax(68px,1fr) minmax(72px,auto)}
