...
/* Models tab as a grid table: name / type / context / billing land in their own
   ...
   The table is a vertical stack of per-row grids — the row grids share the
   same four-column track, which is what keeps header and rows aligned. */
.dlc_table{margin:8px 0 0;display:flex;flex-direction:column}
.dlc_tableHeader{align-items:center;display:grid;color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:500;line-height:1.5;padding:8px;text-align:left;column-gap:12px;grid-template-columns:minmax(120px,max-content) minmax(56px,auto) minmax(68px,1fr) minmax(72px,auto)}
.dlc_tableRow{align-items:center;display:grid;border-bottom:.5px solid var(--dsw-alias-border-l2);padding:5px 8px;column-gap:12px;grid-template-columns:minmax(120px,max-content) minmax(56px,auto) minmax(68px,1fr) minmax(72px,auto)}
...
`;
		...
		*/
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						status.status === "signed-in" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), tab === "account" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: CSS.section,
							children: [
							...
							}), models === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: CSS.table,
								role: "grid",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											role: "columnheader",
											children: t("modelsColModel")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											role: "columnheader",
											children: t("modelsColType")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											role: "columnheader",
											children: t("modelsColContext")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											role: "columnheader",
											children: t("modelsColBill")
										})
									]
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: CSS.tableCell,
											role: "gridcell",
											children: model.contextWindow === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: CSS.ctx,
												children: t("modelsContextNone")
											}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: CSS.ctx,
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: CSS.tableCell,
											role: "gridcell",
											children: model.rate === void 0 && model.promo === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: CSS.dash,
												children: "—"
											}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												className: CSS.listMeta,
												children: [model.rate === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: CSS.pill,
		...
		const en = {
			...
			modelsColBill: "Billing",
			modelsContextNone: "Not provided",
