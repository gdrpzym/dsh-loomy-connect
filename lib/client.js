...
`;
		...
		*/
		...
		const en = {
			...
			modelsImage: "image",
			modelsImageHint: "Plus {count} image generator(s), listed for reference — DSH is a chat surface and never calls them.",
		...
		const zh = {
			...
			modelsImage: "图像",
			modelsImageHint: "另有 {count} 个图像生成模型，仅列出供参考 —— DSH 是对话界面，不会调用它们。",
