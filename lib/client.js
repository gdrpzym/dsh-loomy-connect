...
`;
		...
		*/
		...
		function LoomyPluginCard({ t }) {
			...
			const freeCount = models === void 0 ? 0 : models.filter((model) => model.promo !== void 0).length;
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: model.name
									}), model.image === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: CSS.listNote,
										children: t("modelsImage")
									}) : null]
								}, model.id))
							}), freeCount === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: CSS.hint,
								children: t("modelsFreeHint", { count: freeCount })
							})] })]
						})] }) : null,
		...
		const en = {
			...
			modelsImage: "image",
			modelsFreeHint: "{count} of them are free for a limited time",
			refresh: "Refresh",
